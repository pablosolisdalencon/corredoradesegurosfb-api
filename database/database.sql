...
-- Records of empresas
-- ----------------------------
INSERT INTO `empresas` (`id`, `name`, `description`) VALUES ('1', 'Corredora de seguros FB', 'My first online note');
INSERT INTO `empresas` (`id`, `name`, `description`) VALUES ('2', 'La que empresab', 'Those who say it can not be done, should not interrupt those doing it.');
INSERT INTO `empresas` (`id`, `name`, `description`) VALUES ('3', 'Long Empresa 3', 'This is a very large note, or maybe not...');
INSERT INTO `empresas` (`id`, `name`, `description`) VALUES ('4', 'Napoleon Hill', 'Whatever the mind of man can conceive and believe, it can achieve.');
INSERT INTO `empresas` (`id`, `name`, `description`) VALUES ('5', 'EMpresauria 5', 'A Random Note');

INSERT INTO `empresas`
    (`name`, `description`)
VALUES
    ('Corredora de seguros FB', 'Develop an attitude of gratitude, and give thanks for everything that happens to you, knowing that every step forward is a step toward achieving something bigger and better than your current situation.'),
    ('Cyberware', 'Your attitude, not your aptitude, will determine your altitude.'),
    ('Quiru', 'The greatest discovery of my generation is that a human being can alter his life by altering his attitudes.'),
    ('C@rte', 'Take the attitude of a student, never be too big to ask questions, never know too much to learn something new.'),
    ('Turistech', 'Our attitude towards others determines their attitude towards us.'),
    ('Norman Vincent Peale', 'Watch your manner of speech if you wish to develop a peaceful state of mind. Start each day by affirming peaceful, contented and happy attitudes and your days will tend to be pleasant and successful.'),
    ('W. Clement Stone', 'There is little difference in people, but that little difference makes a big difference. The little difference is attitude. The big difference is whether it is positive or negative.'),
    ('Dale Carnegie', 'Happiness does not depend on any external conditions, it is governed by our mental attitude.'),
    ('Walt Disney', 'If you can dream it, you can do it.'),
